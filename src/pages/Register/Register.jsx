...
const Register = () => {
  ...
  return (
    <div className="dark:bg-slate-800">
      <div className="px-12 sm:px-24 md:px-48 lg:px-12  xl:px-24 xl:max-w-2xl mx-auto py-8 ">
        ...
        <div className="mt-12">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div>
              ...
              <input
                className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-amber-500 dark:bg-slate-900 dark:text-white px-2"
                type=""
                placeholder="Alex"
            ...
            <div className="mt-10">
              ...
              >
                {!isLoading ? "Register" : "Wait until profile picture upload"}
              </button>
            </div>
          </form>
